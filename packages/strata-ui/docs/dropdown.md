...
Accessible dropdown menus with keyboard navigation, typeahead search, nested submenus, and support for interactive items like checkboxes and radios.

## Dropdown Props

| Prop | Type | Default | Options | Description |
|------|------|---------|---------|-------------|
| `id` | string | `null` | Any string | Unique identifier for the dropdown |
| `size` | string | `md` | `sm`, `md`, `lg` | Dropdown content size |
| `placement` | string | `bottom-start` | Any Floating UI placement | Dropdown position relative to trigger |
...
| `placement` | string | `right-start` | Any Floating UI placement | Submenu position relative to parent item |
...
Dropdowns support unlimited nesting levels. Submenus automatically open to the right by default and intelligently flip if space is constrained:
